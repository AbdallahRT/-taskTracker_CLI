...
program
  ...
  .action((task) => {
    fs.readFile(pathfile, "utf-8", (err, data) => {
      ...
      tasks.push(newTask);
      fs.writeFile(pathfile, JSON.stringify(tasks, null, 2), "utf-8", (err) => {
        if (err) {
...
program
    ...
    .action((id, disc) => {
        fs.readFile(pathfile, 'utf-8', (err, data) => {
            ...
            fs.writeFile(pathfile, JSON.stringify(tasks), 'utf-8', (err) => {
                if (err) {
                    console.log('Error', err);
                    process.exit();
                }
...
program
    ...
    .action((id) =>{
        fs.readFile(pathfile, 'utf-8', (err, data) => {
            ...
            fs.writeFile(pathfile, JSON.stringify(newTasks), 'utf-8', (err) => {
                if (err) {
                    console.log('Error', err);
                    process.exit();
                }
